...
#ifndef QR_WEB_MENU_ALSHAMI_ALASL_SWIFT_H
#define QR_WEB_MENU_ALSHAMI_ALASL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="qr_web_menu_alshami_alasl",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC25qr_web_menu_alshami_alasl11AppDelegate")
...
SWIFT_CLASS("_TtC25qr_web_menu_alshami_alasl17MainFlutterWindow")
